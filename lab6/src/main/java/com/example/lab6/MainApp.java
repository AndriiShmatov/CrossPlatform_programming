...
import com.example.lab6.view.PersonOverviewController;
...
import com.example.lab6.model.Person;
import javafx.stage.Modality;
import com.example.lab6.view.PersonEditDialogController;
...
public class MainApp extends Application {
    ...
    public void initRootLayout() {
        ...
        fxmlLoader.setLocation(getClass().getResource("/com/example/lab6/RootLayout.fxml"));
        try {
    ...
    public void showPersonOverview() {
        FXMLLoader fxmlLoader = new FXMLLoader();
        fxmlLoader.setLocation(getClass().getResource("/com/example/lab6/PersonOverview.fxml"));
        try {
    ...
    public boolean showPersonEditDialog(Person person) {
        try{
            ...
            loader.setLocation(MainApp.class.getResource("/com/example/lab6/PersonEditDialog.fxml"));
